...
def main():
    print("=" * 80)
    print("  LightGBM V5 - New Preprocess with V4.1 ")
    print("=" * 80)
    print()
    ...
    # Save model
    print("\nSaving model...")
    with open('lightgbm_model_v5_5fold.pkl', 'wb') as f:
        pickle.dump({
            'models_x': models_x,
            'models_y': models_y,
            'val_score': mean_eucl,
    ...
    print("Saved: lightgbm_model_v5_5fold.pkl")

    print("\n" + "="*80)
    print("Next: python inference_v5.py")
    print("="*80)
