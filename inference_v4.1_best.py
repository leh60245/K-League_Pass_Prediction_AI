...
def main():
    ...
    # 2. 모델 로딩
    print("🔧 V4.1 모델 로딩...")
    with open('lightgbm_model_v4.1_5fold.pkl', 'rb') as f:
    ...
    filename = f'submission_v4.1_optuna_{timestamp}.csv'
    ...
    print("\n성능 비교:")
    print("  V3:  14.535점")
    print("  V4:  14.308점 (-0.227)")
    print(f"  V4.1: 예상 14.0~14.2점 (-0.1~0.3)")
